...
class Base
{
	...
	public static function autoload( $className )
	{
		...
		if( ENV_DEBUG && !class_exists( $className, false ) && !interface_exists( $className, false ) && !trait_exists( $className, false ) ) {
	...
	public static function setAlias( $alias, $path )
	{
		...
		if( $path !== null ) {
			...
			else if( is_string( static::$_aliases[ $root ] ) ) {
				if( $pos === false ) {
					static::$_aliases[ $root ] = $path;
				}
				else {
		...
		else if( isset( static::$_aliases[ $root ] ) ) {
